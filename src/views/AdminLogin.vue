<template>
    <div>
      <div class="head">
        ...
        <div>
          <div style="font-size: 24px">管理员登录</div>
        </div>
      </div>
      <div class="form">
        <div class="form-layout">
          <div class="form-header">
            <span class="form-content">请输入管理员工号</span>
            <span>
  ...
  <script>
import { loginService, adminLoginService } from "../service/login.js"
  ...
  export default {
    ...
    methods: {
      ...
      async loginEvent() {
        const res = await adminLoginService(this.id, this.password);
        ...
        this.$router.push(`/managementpage/${this.id}`);
      },
    },
  };
  </script>
